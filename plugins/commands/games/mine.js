...
const minerals = [
  { name: '𝘊𝘰𝘢𝘭', coinValue: getRandomValue(50000, 10000) },
  { name: '𝘐𝘳𝘰𝘯', coinValue: getRandomValue(10000, 50000) },
  { name: '𝘉𝘳𝘰𝘯𝘻𝘦', coinValue: getRandomValue(50000, 10000) },
  { name: '𝘚𝘪𝘭𝘷𝘦𝘳', coinValue: getRandomValue(100000, 150000) },
  { name: '𝙂𝙤𝙡𝙙', coinValue: getRandomValue(15000, 200000) },
  { name: '💎', coinValue: getRandomValue(20000, 500000) },
...
export async function onCall({ message, args, data }) {
 ...
 const mine = (await axios.get("https://i.imgur.com/56G9Lrn.png", {
    responseType: "stream"
  })).data;
  try {
