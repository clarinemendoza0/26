...
const evolveNames = [
  ...
  "Scizor" , "Magikarp", "Mew" , "Magmar", "Ponyta"
];
...
const evolveImages = [
  ...
  "https://i.imgur.com/bCi9XJ0.jpg",
  "https://i.imgur.com/9lXROQf.jpg"
];

const pokemonNames = ["Pikachu", "Charmander", "Marill", "Squirtle", "Bulbasaur", "Meowth", "Vulpix", "Growlithe", "Vaporeon", "Sylveon", "Cyndaquil", "Totodile", "Piplup", "Froakie", "Pidgey", "Elekid", "Abra", "Seel", "Eevee", "Jigglypuff", "Chikorita","Munchlax", "Wynaut", "Caterpie", "Clefairy", "Psyduck", "Scyther" ,"Magikarp" ,"Mew", "Magmar", "Ponyta"];
const pokemonImages = [
  ...
  "https://i.imgur.com/JIbHBY8.jpg",
  "https://i.imgur.com/9qlqWHT.jpg"
];
...
async function onCall({ message, getLang, args}) {
  ...
  if (args[0] === "feed") {
    ...
    const maxLevel = 200; // Assuming the maximum level is 100
